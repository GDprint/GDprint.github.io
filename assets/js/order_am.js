...
//			email: "goharav88@mail.ru",
		...
		customerData: {
		 ...
		 description: "Գովազդային պաստառ՝ BEER-ՀՅԱՆ գարեջրատան համար։ Ձախում տեղադրված է հայկական զարդանախշով լոգո և ուղղահայաց 'BEER' գրությունը։ Աջում՝ ժպտերես աղջիկ ավանդական հագուստով՝ գարեջրի բաժակներով, սեղանին խեցգետին և նախուտեստ։ Ստորին մասում՝ խորիմաստ հաղորդագրություն՝ «Գարեջուրը որ հիշում ես՝ իզուր չէ անունը»:",
  advantages: [
    "Տեսողական գրավչություն՝ անմիջապես գրավում է ուշադրությունը",
    "Բնօրինակ լոգո և ազգային մոտիվներ՝ հայեցի մոտեցում",
    "Հուզական, հիշվող հաղորդագրություն՝ կապ ապրանքանիշի հետ",
    "Ջերմ, ընկերական միջավայրի փոխանցում՝ խրախուսելով այցելել",
    "Էլեմենտների հավասարակշռված համադրություն՝ առանց գերբեռնվածության"
  ],
