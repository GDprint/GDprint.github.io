...
//			email: "goharav88@mail.ru",
		...
		description: "Այս պատկերում ներկայացված է “CoffeeAreg” անվամբ ֆրեշի և սուրճի կետի մենյուն, որը բաժանված է մի քանի հիմնական խմբերի՝ 🧋 Ֆրեշ և Սառը Խմիչքներ։ Բաժանված են ըստ մրգի կամ համի տեսականի՝ մրգային ֆրեշներ՝ գրեյպֆրուտ, նարինջ, ձմերուկ, բանան, ելակ, ելակ + բանան, խնձոր, կիվի, հատապտուղ, կիտրոն։ Կոկտեյլներ՝ Bubble Tea, նուռ, Տուտ Ֆրուտ, Կարմիր Թեյ։ 👉 Յուրաքանչյուր ըմպելիքի տակ տեղ է թողնված գնի նշման համար (դատարկ սպիտակ դաշտեր)։ ☕ Սուրճի տեսականի՝ տաք սուրճեր, այդ թվում՝ դասական և հատուկ տեսակներ՝ մեկ կարմրակապ ամերիկա հսկայացված, մեկ բրաունի չիզքեյք մոկա, կենտրոն մարմելադով ռոյալ բլու էսպրեսսո ամերիկանո, կապուչինո լուստ լուստ մաքիատո, մաքիատո գլյասե Freolo Corretto, Raf, Romano, Irish Coffee։ 👉 Այս բաժինը նաև բաժանված է տարբեր չափաբաժինների և համադրությունների։ 🎨 Դիզայնը՝ գույնի ֆոնը մուգ շագանակագույն, դասական և ջերմ դիզայնով։ Տառատեսակը՝ խառը՝ անգլերենն ունի ձեռագիր ոճ, իսկ հայերենը՝ խորը, խիտ տառերով։ Խմիչքների պատկերները՝ գունագեղ և գրավիչ, բարձր որակի վիզուալներ՝ գրաֆիկական ձևով։ 💡 Ընդհանուր տպավորություն՝ այս մենյուն շատ գրավիչ է և տրամադրող։ ✅ Մերֆորմացված է ըստ սեզոնային ու պահանջարկ ունեցող ըմպելիքների։ ✅ Նկարների միջոցով հաճախորդը կարող է տեսնել ինչ է պատվիրում։ ✅ Լուսավոր, աչքի ընկնող դիզայն՝ հարմար թե՛ ֆիզիկական կետում տեղադրելու, թե՛ սոց. ցանցերում օգտագործելու համար։",
		images: [
